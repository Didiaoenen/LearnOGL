...
namespace OGL
{
class OpenGLGraphicsCommonBaseManager : public GraphicsManager
{
public:
	void Present() final;
...
private:
	...
	uint32_t mUBOLightInfo[GfxConfiguration::kMaxInFlightFrameCount] = { 0 };
	uint32_t mUBODrawFrameConstant[GfxConfiguration::kMaxInFlightFrameCount] = { 0 };
	uint32_t mUBODrawBatchConstant[GfxConfiguration::kMaxInFlightFrameCount] = { 0 };
	uint32_t mUBOShadowMatricesConstant[GfxConfiguration::kMaxInFlightFrameCount] = { 0 };
